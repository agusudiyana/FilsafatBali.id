    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-gray-500">
                Daftar kiriman Istilah Bali yang menunggu verifikasi.
            </p>
        </div>
    </div>
                ...
                @forelse($istilahs as $istilah)
                    <tr class="border-b hover:bg-gray-50 transition">
                        ...
                        <td class="p-4 text-center">
                            ...
                            @elseif($istilah->status == 'disetujui')
                        ...
                        <td class="p-4 text-center">
                            <div class="flex items-center justify-center gap-3">
                                ...
                                <a href="{{ route('admin.verifikasi.istilah.detail', $istilah->id) }}"
                                    title="Detail / Lihat"
                                ...
                                <form action="{{ route('admin.verifikasi.istilah.setujui', $istilah->id) }}" method="POST"
                                    class="inline">
                                    @csrf
                                ...
                                <form action="{{ route('admin.verifikasi.istilah.tolak', $istilah->id) }}" method="POST"
                                    class="inline">
                                    @csrf

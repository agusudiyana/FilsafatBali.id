            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                class="inline-flex items-center gap-2.5 px-3 py-2 border border-[#E5D6BF] text-sm leading-4 font-medium rounded-xl text-[#2B1A0E] bg-[#FAF6F0] hover:border-[#9B3B24] focus:outline-none transition ease-in-out duration-150">
                                <!-- Avatar Pengguna -->
                                ...
                                <div class="ms-1">
                                    <svg class="fill-current h-4 w-4 text-[#7A624A]" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 20 20">
                        ...
                        <x-slot name="content">
                            <div class="px-4 py-2 border-b border-[#F3ECE1]">
                                <p class="text-[10px] text-gray-400 uppercase tracking-wider">Pengguna</p>
                                <p class="font-bold text-[#2B1A0E] truncate text-xs">{{ Auth::user()->name }}</p>
                            </div>

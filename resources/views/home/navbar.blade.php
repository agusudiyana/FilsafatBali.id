<!-- ========================================== -->
<!-- NAVBAR UTUH (WARNA KUNING EMAS KONSISTEN)  -->
<!-- ========================================== -->
    ...
    <div class="max-w-[1380px] mx-auto px-4 md:px-8 flex items-center justify-between relative">
        ...
        <a href="{{ url('/') }}" class="flex items-center gap-2.5 shrink-0 group">
            ...
            <div class="flex flex-col">
                ...
                <span id="navSubLogo"
                    class="text-[8.5px] md:text-[9px] tracking-[2.5px] uppercase font-semibold text-[#E2B75B] mt-0.5">
                    ARSIPAN BUDAYA
                </span>
            </div>
        </a>
        ...
        <div class="flex items-center gap-3 shrink-0 relative">
            @auth
                ...
                <button type="button" id="userProfileBtn" onclick="toggleUserDropdown(event)"
                    ...
                    <div class="w-9 h-9 rounded-full border-2 border-[#E2B75B] bg-[#8D2B1D] text-white overflow-hidden flex items-center justify-center font-bold text-sm shadow-sm shrink-0 group-hover/user:scale-105 transition-transform">
                    ...
                    <span id="navUsername" 
                        class="nav-dynamic-color hidden sm:inline-block text-[14px] font-medium text-[#E2B75B] tracking-wide capitalize transition-colors duration-500"
                        style="font-family: 'Inter', sans-serif;">
                        {{ auth()->user()->name }}
                    </span>

                    <svg id="navUserChevron" xmlns="http://www.w3.org/2000/svg"
                        class="nav-dynamic-color w-4 h-4 text-[#E2B75B] transition-all duration-500 group-hover/user:translate-y-0.5"
            ...
            @else
                ...
                <a id="navBtnMasuk" href="{{ route('login') }}"
                    class="group/btn border border-[#E2B75B] text-[#E2B75B] bg-transparent px-3.5 py-1.5 rounded-lg text-[11px] font-bold tracking-wide flex items-center gap-1.5 hover:bg-[#E2B75B] hover:text-[#23160E] transition-all duration-200 shadow-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5 text-[#E2B75B] group-hover/btn:text-[#23160E] transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">

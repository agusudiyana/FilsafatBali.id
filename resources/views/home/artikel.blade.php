...
<section id="artikel" class="bg-[#F7F0E7] py-24">
    <div class="max-w-7xl mx-auto px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
            ...
            <!-- CARD 1: AJARAN TETUA -->
            <div onclick="openDetailArtikel(1)"
                class="card-artikel ajaran bg-white rounded-xl overflow-hidden shadow duration-300 cursor-pointer group relative">
                <div class="relative overflow-hidden">
                    <img src="{{ asset('images/subak.jpeg') }}"
                    ...
                    <div
                        ...
                        <span
                            class="bg-[#FAF5ED] text-[#2B1A12] border border-[#D6C5AE] text-[11px] font-bold tracking-[2px] uppercase px-5 py-2.5 rounded-lg shadow-lg flex items-center gap-2 hover:bg-white transition">
                            <i data-feather="external-link" class="w-4 h-4 text-[#B8863B]"></i> BACA ARTIKEL
                        </span>
                    </div>
                    <span
                        class="absolute top-4 left-4 bg-[#992B20] text-white text-[11px] tracking-[2px] uppercase font-semibold px-4 py-2 rounded-full z-10">AJARAN
                        TETUA</span>
                    <span
                        class="absolute top-4 right-4 bg-white/90 backdrop-blur-sm text-[#D9B35D] text-[11px] font-semibold px-4 py-2 rounded-full shadow flex items-center gap-2 z-10">
                        <i data-feather="check-circle" class="w-4 h-4"></i> Terverifikasi
                    </span>
                </div>
                <div class="p-6">
                    <h3 style="font-family:'Cormorant Garamond',serif;"
                        class="text-[34px] leading-tight font-bold text-[#2B1A12] group-hover:text-[#B8863B] transition">
                        Filosofi Subak: Demokrasi Air dalam Peradaban Bali
                    </h3>
                    <p class="mt-4 text-[#675A4D] leading-8 line-clamp-2">Sistem irigasi Subak bukan sekadar teknik
                        pertanian, tetapi merupakan perwujudan nyata Tri Hita Karana.</p>
                    <div class="mt-8 flex items-center justify-between">
                        <div class="text-[13px] text-[#8C7A65]"><span>12 Juni 2025</span><span
                                class="mx-2">•</span><span>8 Menit</span></div>

                        @php
                            $isSaved1 =
                                auth()->check() &&
                                \App\Models\Bookmark::where('user_id', auth()->id())
                                    ->where('item_title', 'Filosofi Subak: Demokrasi Air dalam Peradaban Bali')
                                    ->exists();
                        @endphp
                        <button type="button"
                            ...
                            <i data-feather="bookmark" class="w-5 h-5 {{ $isSaved1 ? 'text-[#B8863B]' : '' }}"
                                style="{{ $isSaved1 ? 'fill:#B8863B; color:#B8863B;' : '' }}"></i>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <!-- CARD 2: CECIMPEDAN -->
            <div onclick="openDetailArtikel(2)"
                class="card-artikel cecimpedan bg-white rounded-xl overflow-hidden shadow duration-300 cursor-pointer group relative">
                <div class="relative overflow-hidden">
                    <img src="{{ asset('images/cecimpedan.jpeg') }}"
                        class="w-full h-60 object-cover group-hover:scale-105 transition duration-500" alt="Cecimpedan">
                    <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition duration-300">
                    </div>
                    <div
                        class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300 transform group-hover:scale-100 scale-95 z-10">
                    ...
                    <span
                        class="absolute top-4 left-4 bg-[#D9A441] text-white text-[11px] tracking-[2px] uppercase font-semibold px-4 py-2 rounded-full z-10">CECIMPEDAN</span>
                    <span
                        class="absolute top-4 right-4 bg-white/90 backdrop-blur-sm text-[#D9B35D] text-[11px] font-semibold px-4 py-2 rounded-full shadow flex items-center gap-2 z-10">
                        <i data-feather="check-circle" class="w-4 h-4"></i> Terverifikasi
                    </span>
                ...
                <div class="p-6">
                    ...
                    <p class="mt-4 text-[#675A4D] leading-8 line-clamp-2">Teka-teki tradisional Bali bukan sekadar
                        hiburan; di dalamnya tersimpan pelajaran logika, ekologi, dan nilai-nilai moral.</p>
                    <div class="mt-8 flex items-center justify-between">
                        <div class="text-[13px] text-[#8C7A65]"><span>10 Juni 2025</span><span
                                class="mx-2">•</span><span>6 Menit</span></div>

                        @php
                            $isSaved2 =
                                auth()->check() &&
                                \App\Models\Bookmark::where('user_id', auth()->id())
                                    ->where('item_title', 'Cecimpedan Bali sebagai Media Pendidikan Karakter Anak')
                                    ->exists();
                        @endphp
                        <button type="button"
                            ...
                            class="relative z-30 w-10 h-10 flex items-center justify-center border border-[#D6C5AE] rounded-lg text-[#8C6A3B] hover:bg-[#F5F0E8] hover:border-[#D9B35D] transition duration-300">
                            <i data-feather="bookmark" class="w-5 h-5 {{ $isSaved2 ? 'text-[#B8863B]' : '' }}"
                                style="{{ $isSaved2 ? 'fill:#B8863B; color:#B8863B;' : '' }}"></i>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <!-- CARD 3: SATUA BALI -->
            <div onclick="openDetailArtikel(3)"
                class="card-artikel satua bg-white rounded-xl overflow-hidden shadow duration-300 cursor-pointer group relative">
                <div class="relative overflow-hidden">
                    <img src="{{ asset('images/jalak bali.jpeg') }}"
                        class="w-full h-60 object-cover group-hover:scale-105 transition duration-500" alt="Jalak Bali">
                    <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition duration-300">
                    </div>
                    <div
                        class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300 transform group-hover:scale-100 scale-95 z-10">
                    ...
                    <span
                        class="absolute top-4 left-4 bg-[#2F7D4B] text-white text-[11px] tracking-[2px] uppercase font-semibold px-4 py-2 rounded-full z-10">SATUA
                        BALI</span>
                    <span
                        class="absolute top-4 right-4 bg-white/90 backdrop-blur-sm text-[#D9B35D] text-[11px] font-semibold px-4 py-2 rounded-full shadow flex items-center gap-2 z-10">
                        <i data-feather="check-circle" class="w-4 h-4"></i> Terverifikasi
                ...
                <div class="p-6">
                    ...
                    <p class="mt-4 text-[#675A4D] leading-8 line-clamp-2">Leucopsar rothschildi, si Jalak Bali yang
                        murni putih, kini tersisa kurang dari 100 ekor di alam liar.</p>
                    <div class="mt-8 flex items-center justify-between">
                        <div class="text-[13px] text-[#8C7A65]"><span>8 Juni 2025</span><span
                                class="mx-2">•</span><span>5 Menit</span></div>

                        @php
                            $isSaved3 =
                                auth()->check() &&
                                \App\Models\Bookmark::where('user_id', auth()->id())
                                    ->where('item_title', 'Jalak Bali: Simbol Keanggunan Yang Terancam Punah')
                                    ->exists();
                        @endphp
                        <button type="button"
                            ...
                            class="relative z-30 w-10 h-10 flex items-center justify-center border border-[#D6C5AE] rounded-lg text-[#8C6A3B] hover:bg-[#F5F0E8] hover:border-[#D9B35D] transition duration-300">
                            <i data-feather="bookmark" class="w-5 h-5 {{ $isSaved3 ? 'text-[#B8863B]' : '' }}"
                                style="{{ $isSaved3 ? 'fill:#B8863B; color:#B8863B;' : '' }}"></i>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <!-- CARD 4: ISTILAH BALI -->
            <div onclick="openDetailArtikel(4)"
                class="card-artikel istilah bg-white rounded-xl overflow-hidden shadow duration-300 cursor-pointer group relative">
                <div class="relative overflow-hidden">
                    <img src="{{ asset('images/sor singgih.jpeg') }}"
                        class="w-full h-60 object-cover group-hover:scale-105 transition duration-500"
                        alt="Sor Singgih">
                    <div
                    ...
                    <span
                        class="absolute top-4 left-4 bg-[#305F9E] text-white text-[11px] tracking-[2px] uppercase font-semibold px-4 py-2 rounded-full z-10">ISTILAH
                        BALI</span>
                    <span
                        class="absolute top-4 right-4 bg-white/90 backdrop-blur-sm text-[#D9B35D] text-[11px] font-semibold px-4 py-2 rounded-full shadow flex items-center gap-2 z-10">
                        <i data-feather="check-circle" class="w-4 h-4"></i> Terverifikasi
                ...
                <div class="p-6">
                    ...
                    <p class="mt-4 text-[#675A4D] leading-8 line-clamp-2">Bahasa Bali mengenal tingkatan tutur—Alus,
                        Madya, Kasar—yang mencerminkan relasi sosial dan etika.</p>
                    <div class="mt-8 flex items-center justify-between">
                        <div class="text-[13px] text-[#8C7A65]"><span>7 Juni 2025</span><span
                                class="mx-2">•</span><span>7 Menit</span></div>

                        @php
                            $isSaved4 =
                                auth()->check() &&
                                \App\Models\Bookmark::where('user_id', auth()->id())
                                    ->where('item_title', 'Sor Singgih: Hierarki Bahasa sebagai Cermin Tatanan Sosial')
                                    ->exists();
                        @endphp
                        <button type="button"
                            ...
                            class="relative z-30 w-10 h-10 flex items-center justify-center border border-[#D6C5AE] rounded-lg text-[#8C6A3B] hover:bg-[#F5F0E8] hover:border-[#D9B35D] transition duration-300">
                            <i data-feather="bookmark" class="w-5 h-5 {{ $isSaved4 ? 'text-[#B8863B]' : '' }}"
                                style="{{ $isSaved4 ? 'fill:#B8863B; color:#B8863B;' : '' }}"></i>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <!-- CARD 5: AJARAN TETUA -->
            <div onclick="openDetailArtikel(5)"
                class="card-artikel ajaran bg-white rounded-xl overflow-hidden shadow duration-300 cursor-pointer group relative">
                <div class="relative overflow-hidden">
                    <img src="{{ asset('images/rwa_bhineda.jpg') }}"
                        class="w-full h-60 object-cover group-hover:scale-105 transition duration-500"
                        alt="Rwa Bhineda">
                    <div
                        class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition duration-300">
                ...
                <div class="p-6">
                    ...
                    <p class="mt-4 text-[#675A4D] leading-8 line-clamp-2">Filosofi yang mengajarkan bahwa segala
                        sesuatu memiliki pasangan yang saling melengkapi dalam harmoni alam.</p>
                    <div class="mt-8 flex items-center justify-between">
                        <div class="text-[13px] text-[#8C7A65]"><span>5 Juni 2025</span><span
                                class="mx-2">•</span><span>8 Menit</span></div>
                        ...
                        @php
                            $isSaved5 =
                                auth()->check() &&
                                \App\Models\Bookmark::where('user_id', auth()->id())
                                    ->where('item_title', 'Rwa Bhineda, Keseimbangan Kehidupan')
                                    ->exists();
                        @endphp
                        <button type="button"
                            ...
                            class="relative z-30 w-10 h-10 flex items-center justify-center border border-[#D6C5AE] rounded-lg text-[#8C6A3B] hover:bg-[#F5F0E8] hover:border-[#D9B35D] transition duration-300">
                            <i data-feather="bookmark" class="w-5 h-5 {{ $isSaved5 ? 'text-[#B8863B]' : '' }}"
                                style="{{ $isSaved5 ? 'fill:#B8863B; color:#B8863B;' : '' }}"></i>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <!-- CARD 6: CECIMPEDAN -->
            <div onclick="openDetailArtikel(6)"
                class="card-artikel cecimpedan bg-white rounded-xl overflow-hidden shadow duration-300 cursor-pointer group relative">
                <div class="relative overflow-hidden">
                    <img src="{{ asset('images/cecimpedan.jpeg') }}"
                        class="w-full h-60 object-cover group-hover:scale-105 transition duration-500"
                ...
                <div class="p-6">
                    ...
                    <p class="mt-4 text-[#675A4D] leading-8 line-clamp-2">Teka-teki Bali tentang benda alam mengandung
                        makna filosofi mendalam dalam menjaga ekosistem.</p>
                    <div class="mt-8 flex items-center justify-between">
                        <div class="text-[13px] text-[#8C7A65]"><span>2 Juni 2025</span><span
                                class="mx-2">•</span><span>9 Menit</span></div>

                        @php
                            $isSaved6 =
                                auth()->check() &&
                                \App\Models\Bookmark::where('user_id', auth()->id())
                                    ->where('item_title', 'Makna Tersembunyi di Balik Cecimpedan tentang Alam')
                                    ->exists();
                        @endphp
                        <button type="button"
                            ...
                            class="relative z-30 w-10 h-10 flex items-center justify-center border border-[#D6C5AE] rounded-lg text-[#8C6A3B] hover:bg-[#F5F0E8] hover:border-[#D9B35D] transition duration-300">
                            <i data-feather="bookmark" class="w-5 h-5 {{ $isSaved6 ? 'text-[#B8863B]' : '' }}"
                                style="{{ $isSaved6 ? 'fill:#B8863B; color:#B8863B;' : '' }}"></i>
                        </button>
                    </div>
                </div>
            </div>
...
<!-- ========================================== -->
<div id="overlayArtikel"
    class="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 hidden opacity-0 transition-opacity duration-300">
    <div id="panelArtikel"
        class="fixed inset-y-0 right-0 w-full max-w-2xl bg-[#FAF6F0] shadow-2xl p-8 overflow-y-auto transform translate-x-full transition-transform duration-300 ease-in-out border-l border-[#D6C5AE]">
        <button onclick="closeDetailArtikel()"
            class="absolute top-6 right-6 w-10 h-10 rounded-full bg-[#EFE6D8] text-[#2B1A12] flex items-center justify-center hover:bg-[#992B20] hover:text-white transition duration-300">✕</button>
        <div class="mb-4">
            <span id="artKategoriBadge"
                class="text-white text-[10px] tracking-[2px] uppercase font-semibold px-3 py-1.5 rounded-full">KATEGORI</span>
        </div>
...
<!-- ========================================== -->
<script>
    // Menyimpan status autentikasi dari PHP/Laravel ke JavaScript
    ...
    function toggleBookmark(event, btn, title, type) {
        ...
        // 2. CEK STATUS LOGIN: Jika Pengguna Belum Login
        if (!IS_USER_LOGGED_IN) {
            // Tampilkan peringatan pesan
            alert("Silakan login terlebih dahulu untuk menyimpan artikel ini ke arsip!");

            // Arahkan ke halaman login setelah pengguna menekan tombol OK
            window.location.href = "{{ route('login') }}"; // Sesuaikan jika nama route/URL login Anda berbeda
            return;
        }
        ...
        // 4. Menangani perubahan Feather Icon (karena <i> diubah jadi <svg> otomatis)
        ...
        // 5. Kirim Request ke Server di Background

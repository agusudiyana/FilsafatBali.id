...
<!-- ========================================== -->
<style>
    /* 1. EFEK KARTU ARTIKEL TERANGKAT NAIK SAAT HOVER */
    .card-artikel {
    ...
    .card-artikel:hover {
        /* Mengangkat latar kartu ke atas sejauh 10px */
        transform: translateY(-10px) !important; 
        
        /* Bayangan lembut agar efek melayang semakin jelas */
    ...
    /* KEYFRAMES ANIMASI GAMBAR / KARTU ARTIKEL MUNCUL SAAT FILTER */
...
<section id="artikel" class="bg-[#F7F0E7] py-24">
    <div class="max-w-7xl mx-auto px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
            ...
            <!-- CARD 1: AJARAN TETUA -->
            <div onclick="openDetailArtikel(1)" class="card-artikel ajaran bg-white rounded-xl overflow-hidden shadow duration-300 cursor-pointer group">
            ...
            <!-- CARD 2: CECIMPEDAN -->
            <div onclick="openDetailArtikel(2)" class="card-artikel cecimpedan bg-white rounded-xl overflow-hidden shadow duration-300 cursor-pointer group">
                <div class="relative overflow-hidden">
            ...
            <!-- CARD 3: SATUA BALI -->
            <div onclick="openDetailArtikel(3)" class="card-artikel satua bg-white rounded-xl overflow-hidden shadow duration-300 cursor-pointer group">
                <div class="relative overflow-hidden">
            ...
            <!-- CARD 4: ISTILAH BALI -->
            <div onclick="openDetailArtikel(4)" class="card-artikel istilah bg-white rounded-xl overflow-hidden shadow duration-300 cursor-pointer group">
                <div class="relative overflow-hidden">
            ...
            <!-- CARD 5: AJARAN TETUA -->
            <div onclick="openDetailArtikel(5)" class="card-artikel ajaran bg-white rounded-xl overflow-hidden shadow duration-300 cursor-pointer group">
                <div class="relative overflow-hidden">
            ...
            <!-- CARD 6: CECIMPEDAN -->
            <div onclick="openDetailArtikel(6)" class="card-artikel cecimpedan bg-white rounded-xl overflow-hidden shadow duration-300 cursor-pointer group">
                <div class="relative overflow-hidden">
...
<div id="overlayArtikel" class="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 hidden opacity-0 transition-opacity duration-300">
    <div id="panelArtikel" class="fixed inset-y-0 right-0 w-full max-w-2xl bg-[#FAF6F0] shadow-2xl p-8 overflow-y-auto transform translate-x-full transition-transform duration-300 ease-in-out border-l border-[#D6C5AE]">
        <button onclick="closeDetailArtikel()" class="absolute top-6 right-6 w-10 h-10 rounded-full bg-[#EFE6D8] text-[#2B1A12] flex items-center justify-center hover:bg-[#992B20] hover:text-white transition duration-300">
            ✕
        </button>
        <div class="mb-4">
            <span id="artKategoriBadge" class="text-white text-[10px] tracking-[2px] uppercase font-semibold px-3 py-1.5 rounded-full">
                KATEGORI
            </span>
        </div>
        <h2 id="artTitle" style="font-family:'Cormorant Garamond',serif;" class="text-3xl md:text-4xl font-bold text-[#2B1A12] leading-tight mb-4">
            Judul Artikel
        </h2>
        <div class="flex items-center gap-3 pb-6 mb-6 border-b border-[#E5D8C5]">
            <div id="artAvatar" class="w-10 h-10 rounded-full bg-[#992B20] text-white font-bold flex items-center justify-center text-sm">
                A
            </div>
            <div>
        ...
        <div id="artIsi" class="text-[#4A3E35] leading-relaxed space-y-4 text-base">
            <!-- Isi artikel dimuat dari JavaScript -->
        </div>
    ...
    function filterArtikel(kategori) {
        ...
        cards.forEach(function(card) {
            ...
            if (kategori === 'semua' || card.classList.contains(kategori)) {
                ...
                // Hapus class animasi setelah 0.5s agar efek hover translateY tetap berjalan halus
                setTimeout(() => {
                    card.classList.remove('card-reveal-anim');
                }, 500);
            } else {

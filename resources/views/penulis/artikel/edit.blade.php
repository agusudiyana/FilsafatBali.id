...
<div class="max-w-4xl mx-auto p-6 bg-[#F6F0E6] text-[#1A110A]">
    ...
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-[#E2D5C3]">
        ...
        <form id="form-artikel" action="{{ route('penulis.artikel.update', $artikel->id) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            @method('PUT')
            ...
            <!-- 3. ISI ARTIKEL (QUILL EDITOR EDIT MODE) -->
            <div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const quillKesimpulan = new Quill('#editor-kesimpulan', {
            theme: 'snow',
            placeholder: 'Edit kesimpulan di sini...',
            modules: { toolbar: toolbarOptions }
        });

...
<style>
    /* 1. Tampilan Toolbar dan Container Editor yang disesuaikan dengan skema warna Krem */
    .ql-toolbar.ql-snow {
...
<div class="p-8">
    ...
    <div class="bg-[#FBF6EE] border border-[#EFE3D3] rounded-2xl p-6 shadow-sm max-w-4xl">
        <form id="form-ajaran-tertua" action="{{ route('penulis.ajaran-tertua.update', $ajaranTertua->id) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            @method('PUT')
            ...
            <!-- 8. Contoh Penerapan (QUILL EDITOR EDIT MODE) -->
            <div>
                <label class="block text-sm font-semibold text-gray-800 mb-1.5">Contoh Penerapan</label>
                <div id="editor-contoh">
                    {!! old('contoh_penerapan', $ajaranTertua->contoh_penerapan) !!}
                </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const quillDeskripsi = new Quill('#editor-deskripsi', {
            theme: 'snow',
            placeholder: 'Edit penjelasan lengkap di sini...',
        ...
        const quillContoh = new Quill('#editor-contoh', {
            theme: 'snow',
            placeholder: 'Edit contoh penerapan di sini...',
            modules: { toolbar: toolbarOptions }
        });

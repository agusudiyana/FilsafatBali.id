...
<div class="max-w-4xl mx-auto bg-white rounded-xl shadow p-8">
    ...
    <form id="form-istilah" action="{{ route('penulis.istilah.update', $istilah->id) }}" method="POST">
        @csrf
        @method('PUT')
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const quillArti = new Quill('#editor-arti', {
            theme: 'snow',
            placeholder: 'Edit arti atau definisi di sini...',
        ...
        const quillSejarah = new Quill('#editor-sejarah', {
            theme: 'snow',
            placeholder: 'Edit sejarah atau penjelasan di sini...',
            modules: { toolbar: toolbarOptions }
        });

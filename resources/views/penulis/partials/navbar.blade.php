<header class="relative bg-white border-b border-gray-200 px-8 py-3.5 flex justify-end items-center z-40" x-data="{ open: false }">
    ...
    <div class="relative z-20 flex items-center gap-3.5">
        ...
        <div class="relative">
            <button @click="open = !open" @click.away="open = false" type="button"
                class="flex items-center gap-3 focus:outline-none bg-[#F7F0E7] hover:bg-[#EFE3CC] border border-[#E6D5B8] px-3.5 py-1.5 rounded-xl shadow-sm transition-all duration-200">

                <!-- Logo Avatar Lingkaran -->
            ...
            <div x-show="open" 
                ...
                class="absolute right-0 mt-2 w-60 bg-white border border-[#E6D5B8] rounded-xl shadow-xl p-3 z-50"
                style="display: none;">

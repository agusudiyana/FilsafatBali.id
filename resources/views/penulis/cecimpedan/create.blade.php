...
<div class="max-w-4xl mx-auto bg-white rounded-xl shadow p-8">
    ...
    <form id="form-cecimpedan" action="{{ route('penulis.cecimpedan.store') }}" method="POST">
        @csrf
        ...
        <!-- 2. Nilai Filosofis (QUILL EDITOR) -->
        <div class="mb-5">
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const quillMakna = new Quill('#editor-makna', {
            theme: 'snow',
            placeholder: 'Tuliskan makna atau penjelasan singkat teka-teki...',
        ...
        const quillFilosofi = new Quill('#editor-filosofi', {
            theme: 'snow',
            placeholder: 'Tuliskan nilai filosofis atau pesan moral mendalam yang terkandung...',
            modules: { toolbar: toolbarOptions }
        });

...
<body
    ...
    <!-- Overlay -->
    <div id="overlay" class="fixed inset-0 bg-black/60 backdrop-blur-sm hidden z-40" onclick="closeSatua()">
    </div>

    <!-- Panel Detail -->
    <div id="panelSatua"
        class="fixed top-0 right-0 w-[560px] h-screen bg-[#F8F0E4]
translate-x-full transition-all duration-500 z-50 overflow-y-auto">

        <div class="relative">

            <img id="detailImage" src="" class="w-full h-64 object-cover">

            <div class="absolute inset-0 bg-black/35"></div>

            <div class="absolute left-6 bottom-6">

                <span id="detailStatus" class="bg-red-700 text-white px-3 py-1 rounded text-xs uppercase">
                </span>

                <h2 id="detailNama" class="text-white text-5xl font-bold mt-3"
                    style="font-family:'Cormorant Garamond',serif;">
                </h2>

                <p id="detailLatin" class="text-white italic">
                </p>
        ...
        <div class="p-8">
            ...
            <div class="border-l-2 border-green-600 pl-4 mb-8">
                <p class="text-xs tracking-[5px] text-green-700 uppercase">Habitat</p>
                <p id="detailHabitat" class="mt-2 text-[#5D4937]"></p>
            </div>

            <div class="border-l-2 border-red-700 pl-4 mb-8">
                <p class="text-xs tracking-[5px] text-red-700 uppercase">
                    Makna Adat & Budaya
                </p>
                <p id="detailMakna" class="mt-2 text-[#5D4937]"></p>
            </div>

            <div class="border-l-2 border-yellow-700 pl-4 mb-8">
                <p class="text-xs tracking-[5px] text-yellow-700 uppercase">
                    Ancaman
                </p>
                <p id="detailAncaman" class="mt-2 text-[#5D4937]"></p>
            </div>

            <div class="border-l-2 border-blue-700 pl-4">
                <p class="text-xs tracking-[5px] text-blue-700 uppercase">
                    Upaya Pelestarian
                </p>
                <p id="detailPelestarian" class="mt-2 text-[#5D4937]"></p>
            </div>
